...
namespace Users.Functions
{
    public class StartupAzure : FunctionsStartup
    {
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddSingleton<ICosmosDBExample>(
                db => new CosmosDBExample(Endpoint, SecretKey, DatabaseId, MaxItemCount)
            );
            ...
            builder.Services.AddScoped<IResultExample, ResultExample>();
            builder.Services.AddScoped<IErrorMessagesExample, ErrorMessagesExample>(); 
            ...
            {
                var context = serviceScope.ServiceProvider.GetService<ICosmosDBExample>();
